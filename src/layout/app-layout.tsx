...
const SidebarContent = ({ onClose, ...rest }: SidebarProps) => {
  ...
  const tenantRoles = ['app-administrator', 'doctor', 'pharmacist', 'marketing-manager'];
  ...
  const LinkItems: Array<LinkItemProps> = [
    ...
    { name: 'Doctor', path: '/doctors', entity: 'doctor', service: AccessServiceEnum.PROJECT, icon: FiUserX },
    {
